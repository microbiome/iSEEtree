...
```{r abundance_density_plot, echo=FALSE, out.width="80%"}
...
```{r scree_plot, echo=FALSE, out.width="20%"}
...
- selecting layout (heatmap, barplot or lollipop)
...
```{r tree_plot, echo=FALSE, out.width="40%"}
...
```{r graph_plot, echo=FALSE, out.width="100%"}
