...
tse_genus <- transformAssay(tse_genus, method = "clr",
                            pseudocount = TRUE)
tse_genus <- transformAssay(tse_genus, method = "z",
                            assay.type = "clr",
                            MARGIN = "features",
                            name = "zclr")
...
# Launch iSEE
if (interactive()) {
  iSEE(tse_genus, initial = c(RowDataTable(), ComplexHeatmapPlot(), RowTreePlot()))
}
```
