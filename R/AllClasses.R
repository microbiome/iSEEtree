tree_slots <- c(layout="character", add_legend="logical",
    ...
    node_size_by="character", node_shape_by="character",
    node_colour_by="character", open.angle="numeric", rotate.angle="numeric",
    branch.length="logical", visual_parameters="character", 
...
#' @rdname RowTreePlot
#' @export
setClass("RowTreePlot", contains="TreePlot", slots=tree_slots)

#' @rdname ColumnTreePlot
#' @export
setClass("ColumnTreePlot", contains="Panel", slots=tree_slots)
